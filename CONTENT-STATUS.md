...
Del chiavi in mano non è stato fornito nessun dato — né prestazioni, né cantieri,
né tempi.

**Decisione del cliente: CMB Costruzioni non compare nel sito.** La sezione
dedicata, il logo e ogni citazione sono stati rimossi. I lavori realizzati in
chiavi in mano restano e si presentano **solo col marchio Moioli**: quando
arriveranno le schede del portfolio, nessuna va firmata CMB.
...
2. **Nessuna competenza attribuita.** Non si dice che Moioli faccia
...
4. **Quello che manca è visibile.** Elenco delle prestazioni e
